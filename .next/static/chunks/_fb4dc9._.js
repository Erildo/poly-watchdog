(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_fb4dc9._.js", {
...
function useTradeMonitor() {
    ...
    trackedTraders.forEach(_s1((trader)=>{
        _s1();
        const { data: trades } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
            queryKey: [
                'trades',
                trader.address
            ],
            queryFn: {
                "useTradeMonitor.useQuery": async ()=>{
                    const res = await fetch(`/api/trades?address=${trader.address}&limit=1`);
                    if (!res.ok) return [];
                    return res.json();
                }
            }["useTradeMonitor.useQuery"],
    ...
    }, "U43AGmsE6nGbSBimMkZqhPGVB4k=", false, function() {
        return [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
        ];
    }));
}
_s(useTradeMonitor, "usCB0xSlgukk0kHTD7+PAlqHHMk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTrackerStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTrackerStore"]
    ];
...
//# sourceMappingURL=_fb4dc9._.js.map